...
public enum GlobalError implements Errors {
    ...
    DATA_ACCESS_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "알 수 없는 오류가 발생하였습니다. 1"),
    JSON_PROCESSING_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "알 수 없는 오류가 발생하였습니다. 2"),
    KAFKA_CONNECTION_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "알 수 없는 오류가 발생하였습니다. 3");
